...
class AbstractDataset:
    ...
    def __init__(self, batch_size: int = 20, dataset_filename='*.txt', test_mode=False):
        ...
        # self.tx_cache = self.tx_cache[0:45000 * self.sample_per_symbol]
        # self.rx_cache = self.rx_cache[0:45000 * self.sample_per_symbol]
        # self.pos_list = self.pos_list[0:45000]
        # self.gt = self.gt[0:45000]
